...
const Inbox = () => {
  ...
  return (
    <div className="flex-1 flex flex-col bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100"> {/* Removed padding here */}
      <div className="flex-1 flex rounded-lg shadow-lg p-4 sm:p-6 lg:p-8"> {/* Added padding here */}
        {/* Conversations List */}
        ...
        {/* Message Area */}
        {selectedConversation && (
          <div className="relative flex flex-col flex-1 w-full h-full bg-gray-50 dark:bg-gray-900"> {/* Added h-full */}
