...
const Inbox = () => {
  ...
  return (
    <div className="flex-1 flex flex-col bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
      <div className="flex-1 flex rounded-lg shadow-lg"> {/* Removed h-full */}
        {/* Conversations List */}
        ...
        {/* Message Area */}
        {selectedConversation && (
          <div className="relative flex flex-col flex-1 w-full bg-gray-50 dark:bg-gray-900"> {/* Removed h-full and padding */}
